    ...
    toast(t =>(
      <div className='flex gap-3 items-center '>
        ...
        <div className='space-x-4'>
            ...
            <button className='btn btn-sm btn-success' onClick={()=> toast.dismiss(t.id)}>Cancel</button>
        </div>
      </div>
    ))
  }
                      ...
                      <div className='flex items-center gap-x-2'>
                        <p
                          className={`px-3 py-1
                            ...
                            ${job.category === 'Web Development' && 'badge badge-error'}
                             ${job.category === 'Graphics Design' && 'badge badge-info'}
                             ${job.category === 'Digital Marketing' && 'badge badge-warning'}
                            `}
                        >
                          {job.category}
                        </p>
